...
- [ ] 8.4 **(ยังไม่ได้ทำ — ต้องรันแอปจริง)** ใบทดสอบด้วยมือภาษาไทย: ออกใบ
      2 เครื่อง → ดาวน์โหลด → เปิดดูว่ามีที่ให้เขียนจริงและลายเซ็นครบ →
      ปิดงาน → เปิดประวัติเครื่องทั้งสองตัว — ทดสอบด้วยตาจาก PDF ที่พิมพ์
      ออกมาจริง ยืนยันด้วยโค้ด/เทสต์อัตโนมัติไม่ได้ ทุกอย่างอื่นใน spec นี้
      ตรวจแล้วว่า shipped ครบ (tsc สะอาด, เทสต์ผ่านหมด, ไม่มี native select)

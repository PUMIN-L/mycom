    ...
    <>
      <div className="mt-8 bg-white rounded-lg shadow p-6 space-y-4">
        ...
        <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg text-sm text-blue-800">
          ...
          จะแสดงหน้า &quot;กำลังปรับปรุง&quot; แทน ส่วนหน้าอื่น (เช่น แคตตาล็อก, เกี่ยวกับเรา, หน้าสินค้า) ยังเข้าชมได้ตามปกติ
          — แต่ทุกหน้ารวมถึงหน้าเหล่านี้จะ<strong>ซ่อนเบอร์โทรศัพท์และข้อมูลการติดต่อ LINE</strong>จากผู้ใช้ทั่วไป
          ผู้ดูแลระบบที่ login แล้วจะยังเห็นข้อมูลติดต่อครบทุกหน้าตามปกติ พร้อมแถบแจ้งเตือนที่มุมขวาบน
        </div>
      </div>

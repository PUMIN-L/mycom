...
export default function MaintenanceBanner() {
  ...
  return (
    <div className="fixed top-20 right-4 z-[100] max-w-xs animate-in fade-in slide-in-from-right duration-300 opacity-60 pointer-events-none">
      <div className="flex items-center gap-2.5 px-4 py-2 bg-amber-50 border border-amber-300 rounded-xl shadow-lg">

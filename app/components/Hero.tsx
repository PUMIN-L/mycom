        ...
        <div className="border-white/20 pt-0 pb-6 md:pb-10 px-0 ">
          ...
          >
            ...
            <button
              ...
              className="group flex items-center gap-3 px-8 py-3 border-2 border-white text-white font-bold transition-all hover:bg-white hover:text-black cursor-pointer"
            >

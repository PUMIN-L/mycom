...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 w-full px-8 mt-40 md:px-20 py-32 md:py-40">
        {/* Tagline */}
        ...
        {/* Title */}
        <h1 className="text-lg md:text-xl lg:text-2xl font-medium leading-tight mb-3 mt-30 animate-fade-in-up opacity-0 delay-200 text-white drop-shadow-2xl">

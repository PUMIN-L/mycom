    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4">
                ...
                {block.type === "gallery" ? (
                  ...
                  <div className="flex flex-col gap-4">
                    <textarea
                      ...
                      rows={4}
                      className="w-full resize-y rounded-lg border border-gray-200 p-3 focus:outline-none focus:border-orange-400 text-gray-800 bg-gray-50"
                      style={{
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                      <div>
                        <label className="block text-xs font-semibold mb-1 text-gray-600">Font Size</label>
                        <select
                          value={block.fontSize || "16"}
                          onChange={(e) => updateBlock(block.id, { fontSize: e.target.value })}
                          className="w-full px-2 py-1 border border-gray-300 rounded text-sm"
                        >
                          <option>12</option><option>16</option><option>18</option><option>24</option><option>32</option><option>48</option>
                        </select>
                      </div>
                      <div>
                        <label className="block text-xs font-semibold mb-1 text-gray-600">Font Weight</label>
                        <select
                          value={block.fontWeight || "400"}
                          onChange={(e) => updateBlock(block.id, { fontWeight: e.target.value })}
                          className="w-full px-2 py-1 border border-gray-300 rounded text-sm"
                        >
                          <option value="400">Normal</option><option value="600">Semibold</option><option value="700">Bold</option><option value="900">Black</option>
                        </select>
                      </div>
                      <div>
                        <label className="block text-xs font-semibold mb-1 text-gray-600">Text Align</label>
                        <select
                      ...
                      <div>
                        <label className="block text-xs font-semibold mb-1 text-gray-600">Color</label>
                        <ColorPickerDropdown
                          color={block.textColor || "#000000"}
                  ...
                  <div className={`flex flex-col md:flex-row gap-8 items-center ${block.imagePosition === 'left' ? 'md:flex-row-reverse' : ''}`}>
        ...
        <button
          ...
          className="w-full px-8 py-4 bg-orange-500 text-white font-bold text-lg rounded-lg hover:bg-orange-600 transition"
        >
          Publish Content
        </button>
